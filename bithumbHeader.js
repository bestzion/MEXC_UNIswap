...
export const XCoinAPI = class {
    constructor(api_key, api_secret) {
        ...
        this.api_key = process.env.Bithumb_API_KEY;
        this.api_secret = process.env.Bithumb_SECRET_KEY;
    }
    xcoinApiCall(endPoint, params) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            console.error("An error occurred in the xcoinApiCall:", err);
    ...
    _getHttpHeaders(endPoint, rgParams, api_key, api_secret) {
        ...
        const message = endPoint + chr(0) + strData + chr(0) + nNonce;
        const signature = cryptoJS.HmacSHA512(message, api_secret).toString(cryptoJS.enc.Base64);
